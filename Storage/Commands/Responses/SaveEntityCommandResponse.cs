...
namespace Sidub.Platform.Storage.Commands.Responses
{
    ...
    public class SaveEntityCommandResponse<TEntity> : ICommandResponse where TEntity : IEntity
    {
        ...
        public SaveEntityCommandResponse(bool isSuccessful, TEntity? result)
        {
