...
namespace Sidub.Platform.Storage.Queries
{
    ...
    /// <summary>
    /// Represents a composite record query that implements both <see cref="IRelationQuery"/> and <see cref="IRecordQuery{TEntity}"/>.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    public class CompositeRecordQuery<TEntity> : IRelationQuery, IRecordQuery<TEntity>
        where TEntity : IEntity
    {
        ...
        /// <summary>
        /// Gets the entity relation associated with the query.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompositeRecordQuery{TEntity}"/> class.
        /// </summary>
        /// <param name="relation">The entity relation.</param>
        public CompositeRecordQuery(IEntityRelation relation)
        {
            Relation = relation;
